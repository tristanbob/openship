...
export const endpoints = {
  ...
  system: {
    ...
    certificateAuthorities: "system/certificate-authorities",
    certificateAuthority: (id: string) => `system/certificate-authorities/${encodeURIComponent(id)}`,
    certificateAuthorityTest: (id: string) => `system/certificate-authorities/${encodeURIComponent(id)}/test`,
    certificateAuthoritySetDefault: (id: string) => `system/certificate-authorities/${encodeURIComponent(id)}/set-default`,
